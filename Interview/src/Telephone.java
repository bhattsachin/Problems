						...
						for (int e = 0; e < ce.length; e++) {
							...
							for (int f = 0; f < cf.length; f++) {
								...
								for (int g = 0; g < cg.length; g++) {
									if(first){
										sb.append("" + ca[a] + cb[b] + cc[c] + cd[d] + cd[e] + cf[f] + cg[g]);
										first = false;
									}else{
										sb.append("," + ca[a] + cb[b] + cc[c] + cd[d] + cd[e] + cf[f] + cg[g]);
									}
