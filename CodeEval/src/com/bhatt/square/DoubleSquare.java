...
public class DoubleSquare {
	...
	public static void main(String[] args) {
		...
		DoubleSquare sq = new DoubleSquare();
		sq.initStuff();
		try{
		...
		//sq.initStuff();
		//System.out.println(sq.getSquareCount(Long.valueOf(10)));
		//System.out.println(sq.getSquareCount(Long.valueOf(25)));
		//System.out.println(sq.getSquareCount(Long.valueOf(3)));
		//System.out.println(sq.getSquareCount(Long.valueOf(0)));
		//System.out.println(sq.getSquareCount(Long.valueOf(1)));
